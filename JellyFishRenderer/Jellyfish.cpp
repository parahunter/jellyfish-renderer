...
{
	float varyingSpeed = wobble_speed * (1 + sin(timeCounter*2*M_PI*frequency + f ))/2;
	position += ( (base_speed + varyingSpeed) / (base_speed + wobble_speed) ) * velocity * deltatime;
